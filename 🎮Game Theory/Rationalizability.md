Games with [[Dominance#^f690d2|dominant-strategy equilibria]] are not very interesting to analyze since each player can just independently pick an optimal strategy.
