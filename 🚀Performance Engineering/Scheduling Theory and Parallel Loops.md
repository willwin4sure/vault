...
> [!proof]-
> Well, $T_{\infty}\ll \frac{T_{1}}{P}$, so the [[Scheduling Theory and Parallel Loops#^f22f4b|greedy scheduling theorem]] tells us that $T_{P}\leq \frac{T_{1}}{T_{P}}+T_{\infty}\approx \frac{T_{1}}{P}$ so the speedup is $\frac{T_{1}}{T_{P}}\approx P$.
